...
* `FEAT`: offer `Change` template action ([#294](https://github.com/bpmn-io/bpmn-js-element-templates/pull/294))
...
* `DEPS`: update to `@bpmn-io/element-templates-validator@2.25.0`
...
* `FIX`: fixed the visibility of template properties based on the `isActive` condition ([#232](https://github.com/bpmn-io/bpmn-js-element-templates/pull/232))
