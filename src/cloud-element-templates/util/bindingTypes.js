...
export const CONDITIONAL_EVENT_DEFINITION_PROPERTY = 'bpmn:ConditionalEventDefinition#property';
export const CONDITIONAL_EVENT_DEFINITION_ZEEBE_CONDITIONAL_FILTER_PROPERTY = 'bpmn:ConditionalEventDefinition#zeebe:conditionalFilter#property';
