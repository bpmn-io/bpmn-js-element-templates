...
describe('provider/cloud-element-templates - ElementTemplates', function() {
  ...
  describe('applyTemplate', function() {
    ...
    it('should not create zeebe:UserTask extension if it exists', inject(function(elementRegistry, elementTemplates) {
    ...
    it('should remove zeebe:UserTask extension if new template has no binding', inject(function(elementRegistry, elementTemplates) {
